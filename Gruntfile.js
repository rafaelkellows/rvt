...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy:{
      ...
      build:{
        //The line bellow can be changed accordding to the project
        src:['**','!node_modules/**','!**/Gruntfile.js','!**/package.json','!less/**','!images/psd/**','!revitech/**',"!docs/**"],
        dest:'dist',
        expand:true
      },
      endbuild:{
      ...
      github:{
        src:['**','!node_modules/**','!revitech/**','!dist/**'],
        dest:'revitech/github',
        expand:true
      }
    },
    watch: {
    ...
    //Usemin Task
    useminPrepare:{
      html:['dist/**.php','dist/**.html','inc/**.php']
    },
    usemin:{
      html:['dist/**.php','dist/**.html','inc/**.php']
    },
