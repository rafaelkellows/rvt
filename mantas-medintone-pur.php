    ...
    <main class="nossosprodutos internal">
      ...
      <section class="carrossel">
        <div class="carr_container">
          <dl>  
            ...
            <dd><img src="images/banners/mantas-medintone-pur.jpg" title="" /></dd>
          </dl> 
        </div>
      </section>
      ...
      <nav class="navg">
        ...
        <ul>
          ...
          <li><a class="active" href="mantas-medintone-pur.php">Medintone Pur</a></li>
      ...
      <article>
        <header>
          <h1>Medintone Pur</h1>
          <em>O Medintone Pur é multifuncional e extremamente prático. Tem a função<br>de absorver o impacto.</em>
        </header>
        <p>O piso vinílico homogêneo em manta medintone tem a tecnologia Pur, que traz um poliuretano reforçado para facilitar a limpeza de baixo custo.<br>Os padrões não direcionais e as cores suaves da linha dão a possibilidade de se criar um amplo leque de composições e desenhos.</p>
        <p class="title"><span>Criatividade e Funcionalidade</span></p>
      ...
      <dl class="characteristics">
        ...
        <dd>
          <ul>
            ...
            <li>PARA PROJETOS DINÂMICOS E CRIATIVOS</li>
            <li>PROTEÇÃO DE SUPERFÍCIE ACRÍLICA PUR</li>
          </ul>
        </dd>
      </dl>
