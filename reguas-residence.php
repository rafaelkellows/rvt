    ...
    <main class="nossosprodutos internal">
      ...
      <nav class="navg">
        ...
        <ul>
          ...
          <li><a class="active" href="reguas-residence.php">Residence</a></li>
        </ul>
      </nav>
      <article>
        <header>
          <h1>Natural Vision Wood Residence</h1>
          <em>Resistente, moderna e disponível em diversos padrões de madeiras naturais, que oferecem redução em até 50% dos ruídos de impacto.</em>
        </header>
      ...
      <aside class="tblDescription">
        <header>PISO VINÍLICO HETEROGÊNEO<br>EM RÉGUA RESIDENCIAL</header>
        <ul>
          <li>
